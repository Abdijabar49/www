...
$logres=null;
						...
						{
						$result = mysqli_query($con,"SELECT * FROM users where username='$_POST[username]' AND password='$_POST[password]' AND status='Active'");
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12 col-md-12 col-sm-12 col-xs-12 text-center">
                <p>Copyright &copy; 2019 <a href="https://alaabo.com">Alaabo.com</a> All rights reserved.</p>
            </div>
        </div>
    </div>
