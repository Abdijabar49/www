...
if(isset($_GET["delid"]))
{
$sqldel = "DELETE FROM contact where id='$_GET[delid]'";
	...
	<?php 
					  ...
					  if($_SESSION["type"]=="Administrator")
					  {
						  ...
						  <td>
                            ...
                            <a  href='viewcontact.php?delid=<?php echo $row ['id'];?>'onclick="return confirm('Are you sure you want to delete this item?');" class="btn btn-danger" ><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
