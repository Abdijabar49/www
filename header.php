...
<html lang="en">
<head>
<link href="images/logo5.jpg" rel="icon"/>
				...
				<div class="row">
					...
					<div class="col-lg-2 col-sm-3 col-3 order-1">
						<div class="logo_container">
							<div class="logo"><font color="white"><b>Ahmed Mansor shopping </font></b></div>
						</div>
					</div>

					<!-- Search -->
					<div class="col-lg-7 order-lg-2 order-3 text-lg-left text-right">
							...
							<div class="header_search_content">
								<div class="header_search_form_container">
									...
									<form class="example" action="searchresult.php">
									  <input type="text" placeholder="Search for products....." name="search"  required="required">
						...
						<div class="page_menu_content">
							...
							<div class="page_menu_search">
								<form action="searchresult.php">
									<input type="text" name="search" required="required" class="page_menu_search_input" placeholder="Search for products...">
								<button type="submit" class="page_menu_search_button" >Search</button>
								</form>
							</div>
							<ul class="page_menu_nav">
								...
								<li class="page_menu_item"><a href="aboutus.php">About us<i class="fa fa-angle-down"></i></a></li>
							</ul>
